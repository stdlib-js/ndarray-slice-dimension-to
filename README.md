...
```javascript
import sliceDimensionTo from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-slice-dimension-to@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-slice-dimension-to/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/ndarray-slice-dimension-to/actions/workflows/test.yml?query=branch:v0.2.1
